...
public class SampleActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		data.add(new WheelItem<>(getResources(), "Text 12", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 13", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 14", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 15", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 16", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 17", android.R.drawable.ic_input_add));
		data.add(new WheelItem<>(getResources(), "Text 18", android.R.drawable.ic_input_add));
